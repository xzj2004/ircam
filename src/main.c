...
static const char* html_style = "body{font-family:Arial,sans-serif;margin:0;padding:0;background-color:#000;height:100vh;overflow:hidden}"
    ...
    "#langSwitch{position:absolute;top:10px;right:10px;display:flex;align-items:center;background:rgba(0,0,0,0.8);padding:8px 12px;border-radius:5px;cursor:pointer;z-index:1000}"
    "#langSwitch:hover{background:rgba(0,0,0,0.9)}"
    "#langSwitch svg{width:20px;height:20px;margin-right:8px}"
    "#langSwitch span{color:#fff;font-size:14px;font-weight:bold}";
static const char* html_head_end = "</style></head><body><div class=\"container\">";
static const char* html_body = "<div id=\"langSwitch\" onclick=\"toggleLanguage()\">"
    "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" style=\"color:#4CAF50\">"
    "<circle cx=\"12\" cy=\"12\" r=\"10\"></circle>"
    "<line x1=\"2\" y1=\"12\" x2=\"22\" y2=\"12\"></line>"
    "<path d=\"M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z\"></path>"
    "</svg>"
    "<span id=\"langText\">ZH / EN</span>"
    "</div>"
    "<div id=\"advancedControls\" style=\"display:none;\">"
    "<div style=\"margin:5px 0;\">"
    "<label><span data-lang-zh=\"高斯模糊\" data-lang-en=\"Gaussian Blur\">高斯模糊</span>: <input type=\"range\" id=\"blurRadius\" min=\"0\" max=\"5\" value=\"0\" step=\"1\"><span id=\"blurValue\">0</span></label>"
    "<label><span data-lang-zh=\"温度范围平滑\" data-lang-en=\"Temp Range Smooth\">温度范围平滑</span>: <input type=\"checkbox\" id=\"tempSmooth\"></label>"
    "<label><span data-lang-zh=\"最小温度\" data-lang-en=\"Min Temperature\">最小温度</span>: <input type=\"number\" id=\"minTempManual\" value=\"15\" step=\"1\"></label>"
    "<label><span data-lang-zh=\"最大温度\" data-lang-en=\"Max Temperature\">最大温度</span>: <input type=\"number\" id=\"maxTempManual\" value=\"35\" step=\"1\"></label>"
    "<button id=\"applyManualRangeButton\" data-lang-zh=\"应用温度范围\" data-lang-en=\"Apply Range\">应用温度范围</button>"
    "<button id=\"resetAutoRangeButton\" data-lang-zh=\"自动温度范围\" data-lang-en=\"Auto Range\">自动温度范围</button>"
    "<label><span data-lang-zh=\"发射率\" data-lang-en=\"Emissivity\">发射率</span>: <input type=\"number\" id=\"emissivity\" value=\"0.95\" min=\"0.1\" max=\"1.0\" step=\"0.01\"></label>"
    "<button id=\"updateEmissivityButton\" data-lang-zh=\"更新发射率\" data-lang-en=\"Update Emissivity\">更新发射率</button>"
    "</div>"
    "</div>"
    "<h1><span data-lang-zh=\"MLX90640 热成像相机\" data-lang-en=\"MLX90640 Thermal Camera\">MLX90640 热成像相机</span><span class=\"fps-display\">(<span id=\"frameRate\">0</span> FPS)</span></h1>"
    "<canvas id=\"thermalCanvas\"></canvas>"
    "<div class=\"controls\">"
    "<select id=\"colormap\">"
    "<option value=\"jet\" data-lang-zh=\"彩虹图\" data-lang-en=\"Jet\">彩虹图</option>"
    "<option value=\"hot\" data-lang-zh=\"热力图\" data-lang-en=\"Hot\">热力图</option>"
    "<option value=\"inferno\" data-lang-zh=\"地狱火\" data-lang-en=\"Inferno\">地狱火</option>"
    "<option value=\"turbo\" data-lang-zh=\"涡轮图\" data-lang-en=\"Turbo\">涡轮图</option>"
    "</select>"
    "<select id=\"interpolation\">"
    "<option value=\"bilinear\" data-lang-zh=\"双线性插值\" data-lang-en=\"Bilinear\">双线性插值</option>"
    "<option value=\"nearest\" data-lang-zh=\"最近邻插值\" data-lang-en=\"Nearest\">最近邻插值</option>"
    "</select>"
    "<select id=\"resolution\">"
    "<option value=\"fullscreen\" data-lang-zh=\"全屏\" data-lang-en=\"Fullscreen\">全屏</option>"
    "<option value=\"1\" data-lang-zh=\"32×24 (原始)\" data-lang-en=\"32×24 (Original)\">32×24 (原始)</option>"
    "<option value=\"3\" data-lang-zh=\"96×72 (3倍)\" data-lang-en=\"96×72 (3x)\">96×72 (3倍)</option>"
    "<option value=\"5\" data-lang-zh=\"160×120 (5倍)\" data-lang-en=\"160×120 (5x)\">160×120 (5倍)</option>"
    "<option value=\"7\" data-lang-zh=\"224×168 (7倍)\" data-lang-en=\"224×168 (7x)\">224×168 (7倍)</option>"
    "<option value=\"9\" data-lang-zh=\"288×216 (9倍)\" data-lang-en=\"288×216 (9x)\">288×216 (9倍)</option>"
    "<option value=\"12\" data-lang-zh=\"384×288 (12倍)\" data-lang-en=\"384×288 (12x)\">384×288 (12倍)</option>"
    "</select>"
    "<button id=\"startButton\" data-lang-zh=\"开始采集\" data-lang-en=\"Start\">开始采集</button>"
    "<button id=\"stopButton\" data-lang-zh=\"停止采集\" data-lang-en=\"Stop\">停止采集</button>"
    "<button id=\"toggleAdvancedButton\" data-lang-zh=\"高级设置\" data-lang-en=\"Advanced\">高级设置</button>"
    "</div>"
    "<div id=\"tempRange\">"
    "<span><span data-lang-zh=\"最低温度\" data-lang-en=\"Min Temp\">最低温度</span>: <span id=\"minTemp\">--</span>&#176;C</span>"
    "<span style=\"margin: 0 20px;\"><span data-lang-zh=\"最高温度\" data-lang-en=\"Max Temp\">最高温度</span>: <span id=\"maxTemp\">--</span>&#176;C</span>"
    "</div>";
